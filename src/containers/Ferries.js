...
export default getSiteProps(() => (
  <div>
      ...
      >
        ...
        <tbody>
          <tr className={css(tachyons('striped--light-gray'))}>
            ...
            <td className={css(tachyons('pv2 ph3 nowrap'))}>7:50 AM</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>8:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>9:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>9:20</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>9:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>9:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>9:50</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:50</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>11:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>11:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>11:50</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>12:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>12:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>12:50</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>1:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>1:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>1:50</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>2:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>2:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>2:50</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>3:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>3:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>3:50</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
          ...
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>5:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>5:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>5:50</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>6:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>6:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>6:50</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>7:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>7:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>7:50</td>
          </tr>
          ...
          <tr className={css(tachyons('striped--light-gray red'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>9:30</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:00 PM</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:20 PM</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray red'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:00</td>
          ...
          <tr className={css(tachyons('striped--light-gray red'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:30 PM</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>-</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>-</td>
          </tr>
        </tbody>
        <tfoot>
          <tr>
            <td colSpan="3" className={css(tachyons('pv4 f4 bg-white'))}>
              Times in <span className={css(tachyons('bg-red ph1 white'))}>RED</span> are Harbour
              Nights Only.
            </td>
          </tr>
        </tfoot>
      ...
      >
        ...
        <tbody>
          <tr className={css(tachyons('striped--light-gray'))}>
            ...
            <td className={css(tachyons('pv2 ph3 nowrap'))}>9:30 AM</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>9:50 AM</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:00</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:30</td>
          ...
          <tr className={css(tachyons('striped--light-gray'))}>
            ...
            <td className={css(tachyons('pv2 ph3 nowrap'))}>6:30 PM</td>
        ...
        <table className={css(tachyons('collapse bg-light-pink black ba br2 b--black-10 pv2 ph3 tc'))}>
          ...
          <tbody>
            ...
            <tr className={css(tachyons('striped--light-gray'))}>
              ...
              <td className={css(tachyons('pv2 ph3 nowrap-ns nowrap'))}>9:35 AM</td>
              <td className={css(tachyons('pv2 ph3 nowrap-ns nowrap'))}>9:30 AM</td>
        ...
        <table className={css(tachyons('collapse bg-light-green black ba br2 b--black-10 pv2 ph3 tc'))}>
          ...
          <tbody>
            ...
            <tr className={css(tachyons('striped--light-gray'))}>
              ...
              <td className={css(tachyons('pv2 ph3 nowrap'))}>7:00 PM</td>
              <td className={css(tachyons('pv2 ph3 nowrap'))}>6:50 PM</td>
    ...
    <orangeroute id="orangeroute" className={css(tachyons('bg-orange white pv3 pv4-ns ph3 ph6-l flex flex-column items-center flex-auto'))}>
      <h1 className={css(tachyons('f3 lh-title tc mb0'))}>
      ...
      <div className={css(tachyons('measure flex flex-column'))}>
        ...
        <div className={css(tachyons('flex flex-row'))}>
          ...
          <div className={css(tachyons('pl2 w-90 lh-copy'))}>Accessible to persons with disability. Limited size wheelchairs, see crew for assistance.</div>
        </div>
      </div>
      <table className={css(tachyons('collapse bg-light-yellow black ba br2 b--black-10 pv2 ph3 tc'))}>
        <caption className={css(tachyons('white f3 f4-ns pv2'))}>
        ...
        <thead>
          <tr>
            <th className={css(tachyons('f5 lh-copy fw6 pv2 ph3'))}>Leave Dockyard</th>
            <th className={css(tachyons('f5 lh-copy fw6 pv2 ph3'))}>Leave St. Georege&rsquo;s</th>
          </tr>
        </thead>
        <tbody>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>-</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>8:30 AM</td>
          </tr>
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>9:30 AM</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>10:30</td>
          ...
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>6:15 PM</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>-</td>
          </tr>
        </tbody>
      </table>
      <table className={css(tachyons('collapse bg-light-yellow black ba br2 b--black-10 pv2 ph3 tc'))}>
        ...
        <tbody>
          ...
          <tr className={css(tachyons('striped--light-gray'))}>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>1:30 PM</td>
            <td className={css(tachyons('pv2 ph3 nowrap'))}>2:30 PM</td>
          </tr>
        </tbody>
      </table>
    </orangeroute>
