...
export default getSiteProps(({ title }) => (
  <div>
    <Head>
      <title>1 • Hamilton • St. George's | {title}</title>
      <meta name="description" content="Bermuda bus schedule: 1 • Hamilton • St. George's" />
    </Head>
    <busschedule
      className={css(
    ...
    >
      <h1 className={css(tachyons('f3 f1-ns lh-copy tc'))}>
        1 &bull; Hamilton &bull; St. George&rsquo;s
        <p className={css(tachyons('f5 f4-ns'))}>
          via Marriott Castle Harbour, The Caves and Grotto Bay
        </p>
      </h1>
        ...
        >
          ...
          <tbody>
            <tr className={css(tachyons('striped--light-gray'))}>
              ...
              <td className={css(tachyons('pv2 ph3'))}>9:52 AM</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>10:15</td>
              <td className={css(tachyons('pv2 ph3'))}>10:52</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>12:15</td>
              <td className={css(tachyons('pv2 ph3'))}>12:52</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>1:15</td>
              <td className={css(tachyons('pv2 ph3'))}>1:52</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>2:15</td>
              <td className={css(tachyons('pv2 ph3'))}>2:52 hs</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>4:15 PM</td>
              <td className={css(tachyons('pv2 ph3'))}>3:52</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>-</td>
              <td className={css(tachyons('pv2 ph3'))}>4:52 PM</td>
            </tr>
          </tbody>
        </table>
        <table
        ...
        >
          ...
          <tbody>
            <tr className={css(tachyons('striped--light-gray'))}>
              ...
              <td className={css(tachyons('pv2 ph3'))}>8:52 AM</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>9:15</td>
              <td className={css(tachyons('pv2 ph3'))}>9:52</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>10:15</td>
              <td className={css(tachyons('pv2 ph3'))}>10:52</td>
            ...
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>2:15</td>
              <td className={css(tachyons('pv2 ph3'))}>2:52</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
      ...
      <div className={css(tachyons('flex flex-column flex-row-l justify-around w-100'))}>
        ...
        >
          ...
          <tbody>
            ...
            <tr className={css(tachyons('striped--light-gray'))}>
              ...
              <td className={css(tachyons('pv2 ph3'))}>65 minutes</td>
            </tr>
          </tbody>
        </table>
        <table
        ...
        >
          ...
          <tbody>
            ...
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>Collectors Hill</td>
              <td className={css(tachyons('pv2 ph3'))}>44 minutes</td>
            </tr>
            <tr className={css(tachyons('striped--light-gray'))}>
              <td className={css(tachyons('pv2 ph3'))}>Hospital</td>
            ...
            <tr className={css(tachyons('striped--light-gray'))}>
              ...
              <td className={css(tachyons('pv2 ph3'))}>60 minutes</td>
            </tr>
          </tbody>
        </table>
      </div>
